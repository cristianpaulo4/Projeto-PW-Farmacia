...
require_once '../Model/clienteDAO.php';
  ...
  $cliente = $cliente->buscarClienteCodigo($conn, $_GET['id']);
...
<form method="POST" action="../Main/mainAlterarClienteFarmacia.php">
  <input type="hidden" name="codigo" value=<?php echo $cliente['idcliente']; ?>>
